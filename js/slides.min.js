    ...
    $form.addEventListener('submit', function(event) {
      ...
      var $freelancer_name = $('#freelancer_name').val(),
        ...
        $freelancer_message = $('#freelancer_message').val();
            $.ajax({
                type: 'POST',
                url: 'freelancer-email-update.php',
                data: {'freelancer_name':$freelancer_name, 'freelancer_email':$freelancer_email, 'freelancer_cell':$freelancer_cell, 'freelancer_message':$freelancer_message},
              cache: false
            });
        $message._hide();
